# routes.rb
	...
	# I'ld like to get this dryed up too.
	# @page = "one of those stringy thingies"
	# @md_layout = { :layout_engine => :erb }
	# This why I'm reading this in Ruby highlighted markdown.
	# I may have to 'pry' open a good Ruby book.
	home = lambda do
